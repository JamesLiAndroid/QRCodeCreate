...
public class CommonActivity extends AppCompatActivity {
	...
	private void openFragment(int key) {
		...
		switch (key) {
            ...
            /*input标签上传文件*/
			case 2:
			    // TODO：QRCodeCreate 访问上传图片的页面
                // TODO：注意更换域名或ip
                ft.add(R.id.container_framelayout, mAgentWebFragment = AgentWebFragment.getInstance(mBundle = new Bundle()), AgentWebFragment.class.getName());
				//mBundle.putString(AgentWebFragment.URL_KEY, "file:///android_asset/upload_file/uploadfile.html");
				//mBundle.putString(AgentWebFragment.URL_KEY, "http://192.168.2.88/QRTools/uploadfile.html");
                mBundle.putString(AgentWebFragment.URL_KEY, "http://192.168.2.88/QRTools/index_mobile_image.php");
                break;
            /*Js上传文件*/
			case 3:
                // TODO：QRCodeCreate 访问文字生成二维码的页面
                // TODO：注意更换域名或ip
				ft.add(R.id.container_framelayout, mAgentWebFragment = AgentWebFragment.getInstance(mBundle = new Bundle()), AgentWebFragment.class.getName());
				//mBundle.putString(AgentWebFragment.URL_KEY, "file:///android_asset/upload_file/jsuploadfile.html");
                mBundle.putString(AgentWebFragment.URL_KEY, "http://192.168.2.88/QRTools/index.php");
                break;
            /*Js*/
			case 4:
